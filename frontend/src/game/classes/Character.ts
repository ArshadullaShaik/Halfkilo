...
export default class Character {
    ...
    isRoaming: boolean;
    moveSpeed: number;
    movementTimer: Phaser.Time.TimerEvent | null;
    ...
    stuckCheckTimer: Phaser.Time.TimerEvent | null = null;
    ...
    constructor(scene: Phaser.Scene, config: any) {
        ...
        this.defaultMessage = config.defaultMessage || "I'm busy, talk to me later.";
    ...
    distanceToPlayer(player: Phaser.Physics.Arcade.Sprite) {
    ...
    isPlayerNearby(player: Phaser.Physics.Arcade.Sprite, distance = 55) {
    ...
    update(player: Phaser.Physics.Arcade.Sprite, isInDialogue: boolean) {
